...
func ConfigFromApp(app BasePather, cfg contracts.ConfigRepository, connection string) (Config, error) {
	if app == nil {
		return Config{}, fmt.Errorf("backup: application unavailable")
	}
	if cfg == nil {
...
func ManagerFromApp(app contracts.App, connection string) (*Manager, error) {
	if app == nil {
